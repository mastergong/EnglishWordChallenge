...
function GamePlay() {
  ...
  return (
    <div className="font-game relative mx-auto flex h-dvh max-w-[420px] flex-col overflow-hidden bg-gradient-to-b from-[#FFF5F2] via-[#FDF2F8] to-[#EEF5FF] text-slate-800">
      ...
      <header className="relative z-10 shrink-0 px-5 pb-2 pt-4">
        ...
        <div className="mt-2 flex items-center justify-between">
          <div className="inline-flex items-center gap-1.5 rounded-full border border-rose-200 bg-rose-100/80 px-3 py-1 text-xs font-bold tracking-wide text-rose-700 shadow-sm">
      ...
      <footer className="relative z-10 shrink-0 border-t border-slate-200/70 bg-white/90 px-4 pb-3 pt-2 shadow-2xl backdrop-blur-md">
        <div className="mb-2 flex items-center justify-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-xl border border-indigo-200/60 bg-indigo-50 px-3 py-1.5 text-xs font-bold text-indigo-700 disabled:opacity-40"
          >
            <span>💡</span>
            คำใบ้
          </button>
