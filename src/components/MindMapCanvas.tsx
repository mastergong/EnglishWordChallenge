  ...
  return (
    <button
      ...
      className={`absolute z-10 rounded-2xl px-2 py-2 text-center shadow-xl ${
        active ? "z-20 bg-blue-600 text-white ring-4 ring-blue-300" : "bg-zinc-800 text-white"
      }`}
      style={{
        left: x,
        top: y,
    ...
    >
      ...
      <p className={`mt-1 text-[11px] leading-tight ${active ? "text-blue-100" : "text-sky-300"}`}>{word.ipa}</p>
